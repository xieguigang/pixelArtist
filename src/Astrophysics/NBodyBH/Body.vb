...
Namespace NBodyBH
    ...
    Public Class Body
        ...
        Private Const G As Double = 0.0000000000667
        ...
        ''' </summary>
        ''' <param name="rx">    the x-position of this new body </param>
        ''' <param name="ry">    the y-position of this new body </param>
        ''' <param name="vx">    the x-velocity of this new body </param>
        ''' <param name="vy">    the y-velocity of this new body </param>
        ''' <param name="mass">  the mass of this new body </param>
        ''' <param name="color"> the color of this new body (RGB) </param>
        ...
        ''' </summary>
        ''' <param name="dt"> the timestep for this simulation </param>
        ...
        ''' </summary>
        ''' <param name="b"> the body from which to determine the distance </param>
        ...
        ''' </summary>
        ''' <param name="b"> the body whose net force on this body to calculate </param>
        Public Overridable Sub addForce(b As Body)
            Dim a = Me
            Dim EPS = 30000.0 ' softening parameter
            Dim dx = b.rx - a.rx
            Dim dy = b.ry - a.ry
        ...
        ''' </summary>
        ''' <param name="b"> the body to aggregate with this Body </param>
