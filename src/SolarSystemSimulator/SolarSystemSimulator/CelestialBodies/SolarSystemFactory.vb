...
Public Module SolarSystemFactory
    ...
    Public Function CreatePlanets() As List(Of CelestialBody)
        ...
        venus.Orbit = New OrbitalElements() With {
            ...
            .LongitudeOfAscendingNode = OrbitalMechanics.DegToRad(76.68),
        ...
        mars.Orbit = New OrbitalElements() With {
            ...
            .Inclination = OrbitalMechanics.DegToRad(1.85),
        ...
        jupiter.Orbit = New OrbitalElements() With {
            ...
            .MeanAnomalyAtEpoch = OrbitalMechanics.DegToRad(20.02),
            .Period = 11.862,
            .BodyRadiusKm = 69911
        }
        ' 木星的四大伽利略卫星
        ...
        jupiter.Moons.Add(CreateMoon("木卫二", "Europa", 4.8E+22, 1560.8,
        ...
        jupiter.Moons.Add(CreateMoon("木卫四", "Callisto", 1.076E+23, 2410.3,
                                     0.01259, 0.0074, 0.19, 0.0457, Color.FromArgb(130, 120, 110), jupiter))
        planets.Add(jupiter)
        ...
        saturn.Orbit = New OrbitalElements() With {
            ...
            .MeanAnomalyAtEpoch = OrbitalMechanics.DegToRad(317.02),
            .Period = 29.4571,
            .BodyRadiusKm = 58232
        }
        ' 土星的主要卫星
        ...
        saturn.Moons.Add(CreateMoon("土卫二", "Enceladus", 1.08E+20, 252.1,
        ...
        saturn.Moons.Add(CreateMoon("土卫八", "Iapetus", 1.806E+21, 734.5,
                                    0.0238, 0.0286, 7.57, 0.002173, Color.FromArgb(160, 150, 140), saturn))
        planets.Add(saturn)
        ...
        uranus.Moons.Add(CreateMoon("天卫一", "Ariel", 1.35E+21, 578.9,
                                    0.00127, 0.0012, 0.26, 0.00069, Color.FromArgb(190, 195, 200), uranus))
        ...
        uranus.Moons.Add(CreateMoon("天卫五", "Oberon", 3.01E+21, 761.4,
                                    0.0039, 0.0014, 0.07, 0.003688, Color.FromArgb(170, 165, 160), uranus))
        planets.Add(uranus)
        ...
        neptune.Orbit = New OrbitalElements() With {
            ...
            .Inclination = OrbitalMechanics.DegToRad(1.77),
        ...
        pluto.Moons.Add(CreateMoon("冥卫一", "Charon", 1.586E+21, 606.0,
                                   0.00013, 0.0022, 0.08, 0.0000175, Color.FromArgb(170, 160, 150), pluto))
        planets.Add(pluto)
