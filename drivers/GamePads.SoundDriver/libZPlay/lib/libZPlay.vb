...
Namespace libZPlay
    ...
    ''' <summary>
    ''' Only supports x86 CPU.(只支持x86平台)
    ''' </summary>
    Public Class ZPlay
...
#Region "Constructor and destructor"
        ...
        Public Sub New()
            ...
            If Not dll.FileExists Then
                Call My.Resources.libzplay.FlushStream(dll)
            End If
...
#Region "Open and close stream"
        ...
        Public Function GetFileFormat(FileName As String) As InternalTypes.TStreamFormat
            Return CType(zplay_GetFileFormatW(objptr, FileName), InternalTypes.TStreamFormat)
        End Function
        ...
        ''' <returns></returns>
        Public Function OpenFile(FileName As String, Optional Format As InternalTypes.TStreamFormat = InternalTypes.TStreamFormat.sfAutodetect) As Boolean
            Return zplay_OpenFileW(objptr, FileName, CInt(Format)) = 1
        End Function

        Public Function SetWaveOutFile(FileName As String, Format As InternalTypes.TStreamFormat, ByRef fOutputToSoundcard As Boolean) As Boolean
            Dim s As Integer = 0
        ...
        Public Function AddFile(FileName As String, Format As InternalTypes.TStreamFormat) As Boolean
            Return zplay_AddFileW(objptr, FileName, CInt(Format)) = 1
        End Function


        Public Function OpenStream(Buffered As Boolean, Dynamic As Boolean, ByRef MemStream() As Byte, StreamSize As UInteger, nFormat As InternalTypes.TStreamFormat) As Boolean
            Dim b As Integer = 0
            Dim m As Integer = 0
            If Buffered Then
                b = 1
...
#Region "Position and Seek"
        ...
        Public Sub GetPosition(ByRef time As InternalTypes.TStreamTime)
            zplay_GetPosition(objptr, time)
        End Sub


        Public Function Seek(TimeFormat As InternalTypes.TTimeFormat, ByRef Position As InternalTypes.TStreamTime, MoveMethod As InternalTypes.TSeekMethod) As Boolean
...
#Region "Echo"
        ...
        Public Function SetEchoParam(ByRef EchoEffectArray() As InternalTypes.TEchoEffect, NumberOfEffects As Integer) As Boolean
            Return zplay_SetEchoParam(objptr, EchoEffectArray, NumberOfEffects) = 1
        End Function

        Public Function GetEchoParam(ByRef EchoEffectArray() As InternalTypes.TEchoEffect) As Integer
...
#Region "Volume and Fade"
        ...
        Public Function SlideVolume(TimeFormatStart As InternalTypes.TTimeFormat, ByRef TimeStart As InternalTypes.TStreamTime, StartVolumeLeft As Integer, StartVolumeRight As Integer, TimeFormatEnd As InternalTypes.TTimeFormat, ByRef TimeEnd As InternalTypes.TStreamTime, EndVolumeLeft As Integer, EndVolumeRight As Integer) As Boolean
...
#Region "ID3 Info"
        ...
        Public Function LoadID3(Id3Version As InternalTypes.TID3Version, ByRef Info As InternalTypes.TID3Info) As Boolean
            Dim tmp As InternalTypes.TID3Info_Internal
        ...
        Public Function LoadID3Ex(ByRef Info As InternalTypes.TID3InfoEx, fDecodePicture As Boolean) As Boolean
            Dim tmp As InternalTypes.TID3InfoEx_Internal
        ...
        Public Function LoadFileID3(FileName As String, Format As InternalTypes.TStreamFormat, Id3Version As InternalTypes.TID3Version, ByRef Info As InternalTypes.TID3Info) As Boolean
            Dim tmp As InternalTypes.TID3Info_Internal
        ...
        Public Function LoadFileID3Ex(FileName As String, Format As InternalTypes.TStreamFormat, ByRef Info As InternalTypes.TID3InfoEx, fDecodePicture As Boolean) As Boolean
            Dim tmp As InternalTypes.TID3InfoEx_Internal
...
#Region "Callback"
        Public Function SetCallbackFunc(CallbackFunc As InternalTypes.TCallbackFunc, Messages As InternalTypes.TCallbackMessage, UserData As Integer) As Boolean
            Return zplay_SetCallbackFunc(objptr, CallbackFunc, Messages, UserData) = 1
        End Function
#End Region

#Region "Beat-Per-Minute"
        Public Function DetectBPM(Method As InternalTypes.TBPMDetectionMethod) As Integer
            Return zplay_DetectBPM(objptr, CUInt(Method))
        End Function

        Public Function DetectFileBPM(FileName As String, Format As InternalTypes.TStreamFormat, Method As InternalTypes.TBPMDetectionMethod) As Integer
...
#Region "FFT Graph and FFT values"
        ...
        Public Function GetFFTData(FFTPoints As Integer, FFTWindow As InternalTypes.TFFTWindow, ByRef HarmonicNumber As Integer, ByRef HarmonicFreq() As Integer, ByRef LeftAmplitude() As Integer, ByRef RightAmplitude() As Integer, ByRef LeftPhase() As Integer, ByRef RightPhase() As Integer) As Boolean
        ...
        Public Function SetFFTGraphParam(ParamID As InternalTypes.TFFTGraphParamID, ParamValue As Integer) As Boolean
            Return zplay_SetFFTGraphParam(objptr, CInt(Fix(ParamID)), ParamValue) = 1
        End Function

        Public Function GetFFTGraphParam(ParamID As InternalTypes.TFFTGraphParamID) As Integer
...
#Region "Status and Info"
        ...
        Public Sub GetStreamInfo(ByRef info As InternalTypes.TStreamInfo)
            Dim tmp As InternalTypes.TStreamInfo_Internal
        ...
        Public Sub GetStatus(ByRef status As InternalTypes.TStreamStatus)
            zplay_GetStatus(objptr, status)
        End Sub


        Public Sub GetDynamicStreamLoad(ByRef StreamLoadInfo As InternalTypes.TStreamLoadInfo)
...
#Region "Wave Out and Wave In Info"
        ...
        Public Function GetWaveOutInfo(Index As UInteger, ByRef Info As InternalTypes.TWaveOutInfo) As Boolean
            Dim tmp As InternalTypes.TWaveOutInfo_Internal
        ...
        Public Function GetWaveInInfo(Index As UInteger, ByRef Info As InternalTypes.TWaveInInfo) As Boolean
            Dim tmp As InternalTypes.TWaveInInfo_Internal
...
#Region "Settings"
        ...
        Public Function SetSettings(SettingID As InternalTypes.TSettingID, Value As Integer) As Integer
            Return zplay_SetSettings(objptr, SettingID, Value)
        End Function


        Public Function GetSettings(SettingID As InternalTypes.TSettingID) As Integer
