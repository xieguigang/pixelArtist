...
Public Class FbxBinaryWriter
    ...
    ReadOnly output As Stream
    ReadOnly memory As MemoryStream
    ReadOnly stream As BinaryWriter
    ...
    ''' </summary>
    Shared ReadOnly writePropertyActions As New Dictionary(Of Type, WriterInfo)() From {
